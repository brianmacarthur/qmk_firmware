...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, ADJUST,  LOWER,   KC_LSFT, KC_SPC,  RAISE,   ADJUST,  KC_RALT, KC_GUI,  KC_RCTL \
),
...
[_DVORAK] = KEYMAP( \
  ...
  FN1,     KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_QUOT, \
...
[_LOWER] = KEYMAP( \
  ...
  KC_ESC,  LCTL(KC_A),LCTL(KC_S),LCTL(KC_D),LCTL(KC_F),LCTL(KC_G),_______,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
  _______, LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),LCTL(KC_V),LCTL(KC_B),_______,S(KC_NUHS),S(KC_NUBS),_______, _______, _______, \
...
[_FN1] = KEYMAP( \
  ...
  _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_PGUP, KC_UP,   _______, _______, KC_DEL, \
 ...
 * |      |Qwerty|      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |Dvorak|      |Aud on|Audoff|AGnorm|AGswap|      |      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Colmak|      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
...
[_ADJUST] =  KEYMAP( \
  ...
  _______, DVORAK,  _______, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, _______, _______, _______, _______, _______, \
