...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, RAISE,   LOWER,   KC_LSFT, KC_SPC,  RAISE,   LOWER,   KC_RALT, KC_RGUI, KC_RCTL \
),
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, ADJUST,  _______, _______, _______, ADJUST,  _______, _______, _______, _______ \
),
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_LT,   KC_GT,   _______, \
  _______, _______, _______, _______, ADJUST,  _______, _______, _______, ADJUST,  _______, _______, _______ \
),
