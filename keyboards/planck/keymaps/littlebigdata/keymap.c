 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Esc  |Lower |Shift |Space |Raise | Del  | Alt  | GUI  | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_LCTL,               KC_LGUI, KC_LALT, KC_ESC,  LOWER,   KC_LSFT, KC_SPC,  RAISE,   KC_DEL,  KC_RALT, KC_RGUI, KC_RCTL} // GRID: 1U dedicated shift and space keys
  // {KC_LCTL,      KC_LGUI, KC_LALT, KC_ESC,  LOWER,MT(MOD_LSFT, KC_SPC),RAISE,   KC_ESC,  KC_RALT, KC_RGUI, KC_RCTL} // MIT: 2U space key with mod shift
},
 ...
 */
[_FUNCTION] = {
  {KC_ESC , _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_PGUP, KC_UP,   _______, KC_PSCR, KC_DEL},
...
[_COLEMAK] = {
  ...
  {KC_LCTL,      KC_LGUI, KC_LALT, KC_ESC,  LOWER,   KC_LSFT, KC_SPC,  RAISE,   KC_ESC,  KC_RALT, KC_RGUI, KC_RCTL} // GRID: 1U dedicated shift and space keys
  // {KC_LCTL,      KC_LGUI, KC_LALT, KC_ESC,  LOWER,MT(MOD_LSFT, KC_SPC),RAISE,   KC_ESC,  KC_RALT, KC_RGUI, KC_RCTL} // MIT: 2U space key with mod shift
},
...
[_DVORAK] = {
  ...
  {LT(_FUNCTION, KC_TAB), KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH},
