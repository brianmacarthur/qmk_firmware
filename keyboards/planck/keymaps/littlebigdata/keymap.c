...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC_LCTL,               KC_LGUI, KC_LALT, KC_ESC,  LOWER,   KC_LSFT, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT // GRID: 1U dedicated shift and space keys
),
...
[_ADJUST] = LAYOUT_planck_grid(
  _______, RESET,   DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, LCTL(LALT(KC_DEL)) ,
