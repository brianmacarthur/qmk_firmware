...
[_QWERTY] = {
  ...
  {LT(FUNCTION, KC_ESC),     KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT},
  {KC_LSFT,                  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT, KC_ENT)},
  {KC_LCTL,                  KC_LGUI, KC_LALT, KC_ESC,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_ESC,  KC_RALT, KC_RGUI, KC_RCTL}
},
...
[_COLEMAK] = {
  ...
  {LT(FUNCTION, KC_ESC),     KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT},
...
[_DVORAK] = {
  ...
  {LT(FUNCTION, KC_ESC),     KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH},
